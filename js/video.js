...
_V_.ControlBarControls = _V_.Component.extend({
...
_V_.FullscreenToggle = _V_.Button.extend({
  ...
  onClick: function(){
    if (!this.player.isFullScreen) {
      this.el.title = 'Small size';
      this.player.requestFullScreen();
    } else {
      this.el.title = 'Full screen';
...
_V_.TimeDivider = _V_.Component.extend({
  ...
  createElement: function(){
    return this._super("div", {
      className: "vjs-time-divider vjs-time-controls vjs-control",
...
// pdf button
_V_.PdfButton = _V_.Button.extend({
init: function(player, options) {
	this._super(player, options);
},
...
buildCSSClass: function(){
	return "vjs-pdf-button vjs-menu-button " + this._super();
},
